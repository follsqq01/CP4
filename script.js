document.addEventListener("DOMContentLoaded", function () {
  ...
  // Обработка клика по кнопке "NEWS"
  document
    .getElementById("news-button")
    .addEventListener("click", function (e) {
      e.preventDefault();
      centerContainer.classList.add("fade-out"); // Затемняем только текст

      // Ждем окончания анимации и перенаправляем с текущим временем видео
